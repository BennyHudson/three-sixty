...
export const LogoGridWrapper = styled.div((props: StyledLogoGridProps): FlattenSimpleInterpolation => css`
...
export const Logo = styled.div((props: StyledLogoGridProps): FlattenSimpleInterpolation => css`
  display: flex;
  align-items: center;
  justify-content: center;
`)
